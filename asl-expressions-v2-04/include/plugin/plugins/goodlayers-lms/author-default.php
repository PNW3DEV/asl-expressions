		...
		<div class="gdlr-lms-container gdlr-lms-container">
			<div class="gdlr-lms-item">
				<?php
					...
					if( !empty($author_meta['phone'][0]) ){
						echo '<div class="author-info phone"><i class="fa fa-phone icon-phone"></i>' . $author_meta['phone'][0] . '</div>';
					}
					echo '<div class="author-info mail"><i class="fa fa-envelope-o icon-envelope-alt"></i><a href="mailto:' . $author_data->user_email . '" >' . $author_data->user_email . '</a></div>';
