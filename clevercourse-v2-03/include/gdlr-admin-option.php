							...
							'options' => array(
								...
								'top-bar-color' => array(
									...
									'options' => array(						
										...
										'top-bar-bottom-border' => array(
											...
											'type' => 'colorpicker',
											'default' => '#eeeeee',
											'selector'=> '.top-navigation-wrapper{ border-color: #gdlr#; }'
										),
								...
								'content-item-2' => array(
									...
									'options' => array(		
										...
										'stunning-text-button-text' => array(
											'title' => __('Stunning Text Button Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-stunning-text-item.type-normal .stunning-text-button{ color: #gdlr#; }'
										),
										'stunning-text-button-background' => array(
											'title' => __('Stunning Text Button Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#555555',
											'selector'=> '.gdlr-stunning-text-item.type-normal .stunning-text-button{ background-color: #gdlr#; }'
										),
								...
								'blog-color' => array(
									...
									'options' => array(
										...
										'blog-info-head-color' => array(
											'title' => __('Blog Info Head Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#575757',
											'selector'=> '.blog-info .gdlr-head{ color: #gdlr#; }'
										),
										'blog-date-day' => array(
											'title' => __('Blog Date Day ( Full/Medium )', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#404040',
										...
										'blog-widget-background' => array(
											'title' => __('Blog Widget Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f5f5f5',
										...
										'blog-widget-bottom-border' => array(
											...
											'type' => 'colorpicker',
											'default' => '#95e0da',
											'selector'=> '.gdlr-blog-widget{ border-color: #gdlr#; }'
										),
								...
								'portfolio-color' => array(
									...
									'options' => array(
										...
										'modern-portfolio-content-background' => array(
											'title' => __('Modern Portfolio Content Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f5f5f5',
											'selector'=> '.portfolio-item-holder .gdlr-modern-portfolio .portfolio-content-wrapper{ background: #gdlr#; }'
										),
										'modern-portfolio-bottom-border' => array(
											'title' => __('Modern Portfolio Bottom Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#95e0da',
